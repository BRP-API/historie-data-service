...
Functionaliteit: test dat alleen de juiste verblijfplaatsen worden geleverd in geval van onbekende aanvang opeenvolgende verblijfplaatsen
  ...
  Regel: Een verblijfplaats met onbekende aanvang van het verblijf en onbekende aanvang vorige binnen de onzekerheidsperiode van het verblijf wordt niet geleverd wanneer de gevraagde periode eindigt op of voor de eerste dag van de onzekerheidsperiode van het vorige verblijf
    ...
    Abstract Scenario: lever alleen A4, omdat <omschrijving>
      ...
      Dan heeft de response verblijfplaatsen met de volgende gegevens
      | gemeenteVanInschrijving.code | gemeenteVanInschrijving.omschrijving | adresseerbaarObjectIdentificatie | straat        | datumAanvangAdreshouding | datumAanvangVolgendeAdreshouding | functieAdres.code | functieAdres.omschrijving |
      | 0800                         | Hoogeloon, Hapert en Casteren        | 0800010000000004                 | Vierde straat | <aanvang 4>              |                                  | W                 | woonadres                 |
