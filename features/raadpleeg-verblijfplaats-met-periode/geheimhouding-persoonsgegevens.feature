...
Functionaliteit: raadplegen verblijfplaatshistorie met periode levert geheimhoudingPersoonsgegevens
  ...
  Regel: Indicatie geheim met waarde hoger dan 0 wordt altijd meegeleverd
    ...
    Abstract Scenario: gevraagde persoon heeft indicatie geheim met waarde <indicatie geheim>
      ...
      | datumAanvangAdreshouding | adresseerbaarObjectIdentificatie | gemeenteVanInschrijving.code | gemeenteVanInschrijving.omschrijving | functieAdres.code | functieAdres.omschrijving |
      | 20100818                 | 0800010000000001                 | 0800                         | Hoogeloon, Hapert en Casteren        | W                 | woonadres                 |
