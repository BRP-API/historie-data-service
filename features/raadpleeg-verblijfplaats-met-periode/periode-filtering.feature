...
Functionaliteit: alleen verblijfplaatsen die binnen de gevraagde periode vallen worden geleverd
  ...
  Regel: Een verblijfplaats wordt niet geleverd, wanneer de gevraagde periode ligt voor het betreffende verblijf
  ...
  Regel: Een verblijfplaats wordt niet geleverd, wanneer de gevraagde periode begint na vertrek uit betreffende verblijf
