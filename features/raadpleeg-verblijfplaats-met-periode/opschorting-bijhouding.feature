...
Functionaliteit: raadplegen historie met periode op persoonslijst met opschorting bijhouding
  ...
  Regel: Voor een persoon op een logisch verwijderde persoonslijst wordt geen verblijfplaatshistorie geleverd
    ...
    Scenario: Gevraagde persoon heeft een logisch verwijderde persoonslijst en met zelfde burgerservicenummer een actuele persoonslijst
      ...
      | straat | datumAanvangAdreshouding | gemeenteVanInschrijving.code | gemeenteVanInschrijving.omschrijving | straat           | functieAdres.code | functieAdres.omschrijving |
      | Laan   | 20100818                 | 0800                         | Hoogeloon, Hapert en Casteren        | Korte straatnaam | W                 | woonadres                 |
  ...
  Regel: opschortingBijhouding wordt geleverd
    ...
    Abstract Scenario: historie wordt gevraagd van persoon waarvoor de bijhouding is opgeschort
      ...
      | 0800                         | Hoogeloon, Hapert en Casteren        | 20220801                 | Korte straatnaam | W                 | woonadres                 |
    ...
    Abstract Scenario: historie wordt gevraagd van persoon waarvoor de bijhouding is opgeschort met periode <omschrijving> opschorting (overlijden)
      ...
      Dan heeft de response verblijfplaatsen met de volgende gegevens
      | gemeenteVanInschrijving.code | gemeenteVanInschrijving.omschrijving | datumAanvangAdreshouding | straat           | functieAdres.code | functieAdres.omschrijving |
      | 0800                         | Hoogeloon, Hapert en Casteren        | 20160801                 | Korte straatnaam | W                 | woonadres                 |
      En heeft de response de volgende gegevens
      | naam                                     | waarde     |
