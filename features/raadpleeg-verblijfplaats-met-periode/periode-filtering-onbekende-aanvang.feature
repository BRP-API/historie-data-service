...
Functionaliteit: test dat alleen verblijfplaatsen met onbekende datum aanvang die binnen de gevraagde periode vallen worden geleverd
  ...
  Regel: De verblijfplaats wordt niet geleverd wanneer gevraagde periode eindigt voor de 1e dag van de onzekerheidsperiode van de aanvang
  ...
  Regel: Een verblijfplaats met onbekende aanvang van het verblijf en (bekende) aanvang vorige verblijf binnen de onzekerheidsperiode wordt niet geleverd wanneer de gevraagde periode eindigt op of voor de aanvang vorige verblijf
    ...
    Abstract Scenario: verblijf met aanvang adreshouding <soort datum> en (bekende) aanvang vorige in de onzekerheidsperiode wordt geleverd, omdat <omschrijving>
      ...
      | 0800                         | Hoogeloon, Hapert en Casteren        | 0800010000000001                 | Eerste straat | 20100526                 | <aanvang adreshouding>           | W                 | woonadres                 |
