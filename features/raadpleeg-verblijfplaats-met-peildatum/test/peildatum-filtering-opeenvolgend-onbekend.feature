...
Functionaliteit: test dat alleen de juiste verblijfplaats(en) wordt geleverd in geval van onbekende aanvang opeenvolgende verblijfplaatsen en vragen met peildatum
  ...
  Regel: Een verblijfplaats met onbekende aanvang van het verblijf en onbekende aanvang vorige binnen de onzekerheidsperiode van het verblijf wordt niet geleverd wanneer de gevraagde peildatum ligt op of voor de eerste dag van de onzekerheidsperiode van het vorige verblijf
