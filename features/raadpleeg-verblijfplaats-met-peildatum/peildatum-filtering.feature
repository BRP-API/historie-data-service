...
Functionaliteit: test dat alleen de verblijfplaats(en) waar persoon verbleef op peildatum wordt geleverd
  ...
  Regel: Een verblijfplaats wordt niet geleverd, wanneer de gevraagde peildatum ligt voor het betreffende verblijf
    ...
    Abstract Scenario: verblijf wordt geleverd, omdat <omschrijving>
      ...
      | 0800                         | Hoogeloon, Hapert en Casteren        | 0800010000000001                 | Eerste straat | 20100818                 | W                 | woonadres                 |
    ...
    Abstract Scenario: verblijf buitenland wordt niet geleverd, omdat <omschrijving>
      ...
      | 0800                         | Hoogeloon, Hapert en Casteren        | 0800010000000001                 | Eerste straat | 20041014                 | 20100818                            | W                 | woonadres                 |
  ...
  Regel: Een verblijfplaats wordt niet geleverd, wanneer de gevraagde peildatum ligt na vertrek uit betreffende verblijf
    ...
    Abstract Scenario: verblijf wordt niet geleverd, omdat <omschrijving>
      ...
      Dan heeft de response verblijfplaatsen met de volgende gegevens
      | gemeenteVanInschrijving.code | gemeenteVanInschrijving.omschrijving | adresseerbaarObjectIdentificatie | straat        | datumAanvangAdreshouding | functieAdres.code | functieAdres.omschrijving |
      | 0800                         | Hoogeloon, Hapert en Casteren        | 0800010000000002                 | Tweede straat | 20160526                 | W                 | woonadres                 |
